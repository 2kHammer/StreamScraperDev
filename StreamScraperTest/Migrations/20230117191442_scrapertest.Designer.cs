...
namespace StreamScraperTest.Migrations
{
    ...
    [Migration("20230117191442_scrapertest")]
    partial class scrapertest
    {
            ...
            modelBuilder.Entity("ContentinformationsCountries", b =>
                {
                    ...
                    b.Property<int>("CountrieCountryId")
                        .HasColumnType("int");

                    b.HasKey("ContentinformationId", "CountrieCountryId");

                    b.HasIndex("CountrieCountryId");
            ...
            modelBuilder.Entity("StreamScraperTest.Database.Models.Contenttypes", b =>
                {
                    ...
                    b.Property<int>("ContenttypeDescription")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentinformationsCountries", b =>
                {
                    ...
                    b.HasOne("StreamScraperTest.Database.Models.Countries", null)
                        .WithMany()
                        .HasForeignKey("CountrieCountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
